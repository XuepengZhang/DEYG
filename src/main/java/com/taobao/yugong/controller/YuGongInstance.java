...
public class YuGongInstance extends AbstractYuGongLifeCycle {
    ...
    private RecordCacheApplier recordCache;
                ...
                private void processTable() {
                    try {
                        ...
                        do {
                            ...
                            for (int i = 0; i < retryTimes; i++) {
                                try {
                                    recordCache.applierCache(records);
//                                    applier.apply(records);
            ...
            logger.info("table[{}] start successful. extractor:{} , translator:{}", new Object[] {
                    context.getTableMeta().getFullName(), extractor.getClass().getName(),
    ...
    public RecordCacheApplier getRecordCache() {
        return recordCache;
    }

    public void setRecordCache(RecordCacheApplier recordCache) {
